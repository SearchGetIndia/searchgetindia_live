...
<div className="col-lg-4">
    ...
    className="form-control"  placeholder="Service Name"/>
   
    </div>
    <div className="form-group col-md-6">
       <input type="text"
        className="form-control"  placeholder="About services"/>
    </div>
    ...
    <div className="form-group col-md-6">
    <input type="text" className="form-control"  placeholder="District Name"/>
    </div>

    <div className="form-group col-md-6">
    <input type="text" className="form-control"  placeHolder="Sub District Name"/>
    </div>
